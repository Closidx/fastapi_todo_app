...
async def create_new_user(new_user_model: CreateUser, db: Session = Depends(get_db)):
    ...
    create_user_model.username = new_user_model.username
    create_user_model.first_name = new_user_model.first_name
    create_user_model.last_name = new_user_model.last_name

    hash_password = get_password_hash(new_user_model.password)
